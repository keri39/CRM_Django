...
class ll_ATS(unittest.TestCase):
    ...
    def test_ll(self):
        ...
        elem = driver.find_element(By.XPATH, '//*[@id="app-layout"]/div[2]/div/div[3]/table/tbody/tr/td[8]/a').click()
        time.sleep(5)
        try:
            elem = driver.find_element(By.XPATH, '//*[@id="app-layout"]/div[2]/div/form/button').click()
            print("Test passed - Services list updated")
            assert True
        except NoSuchElementException:
            self.fail("Services List is not updated when update service is clicked - test failed")
